...
func _ready():
	...
	texture_button_nodes = [
		get_node("แซลม่อนย่าง1"),
		get_node("แซลม่อนย่าง2")
	]
...
func load_texture(path: String, texture_button: TextureButton) -> void:
	...
	var texture = preload("res://ร้านอาหารที่ 2/ร้านอาหารทะเลใหม่/ชิ้นแซลม่อน.png")
	if texture:
...
func _on_ปลาก่อนย่าง_pressed():
	if current_texture_index < texture_button_nodes.size():
		...
		load_texture("res://ร้านอาหารที่ 2/ร้านอาหารทะเลใหม่/ชิ้นแซลม่อน.png", current_texture_button)
