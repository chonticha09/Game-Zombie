...
func _ready():
	...
	texture_rect_nodes.append(get_node("ชา2_1"))
...
func load_texture(path: String, texture_rect: TextureRect) -> void:
	var texture = preload("res://อาหารจีน/รวมอาหารจีน/ชา.png")
	if texture:
...
func _on_button_pressed():
	...
	if current_texture_index < texture_rect_nodes.size():
		...
		load_texture("res://อาหารจีน/รวมอาหารจีน/ชา.png", current_texture_rect)
