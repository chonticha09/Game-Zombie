...
func _ready():
	...
	texture_rect_nodes.append(get_node("ซูชิแซลมอน"))
...
func load_texture(path: String, texture_rect: TextureRect) -> void:
	var texture = preload("res://ร้านอาหารญี่ปุ่น/สุ่มอาหาร/ซุซิแซลม่อน.png")
	if texture:
...
func _on_button_3_pressed():
	...
	if current_texture_index < texture_rect_nodes.size():
		...
		load_texture("res://ร้านอาหารญี่ปุ่น/สุ่มอาหาร/ซุซิแซลม่อน.png", current_texture_rect)
