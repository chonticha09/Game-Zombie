...
func load_texture(path: String, texture_button: TextureButton) -> void:
	...
	var texture = preload("res://ร้านอาหารที่ 2/ร้านอาหารทะเลใหม่/เฟรนฟรายง.png")
	if texture:
